...
#define MAIN_MENU_VERTICAL_SPACING		102
...
*/
	case ID_EXIT:
		UI_ConfirmMenu( "EXIT GAME?", MainMenu_ExitAction );
		break;
	}
}
...
*/	
	...
	s_main.multiplayer.generic.x			= 160;//320;
	...
	s_main.setup.generic.x					= 160;//320;
